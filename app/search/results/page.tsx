...
function SearchResultsFallback(){
  return <main className="search-results-page" dir="rtl">
    <nav className="results-breadcrumb" aria-label="مسیر بازگشت"><a href="/"><span className="brand-mark" aria-hidden="true">ک</span>کارن‌سیر</a><i aria-hidden="true">←</i><span>نتایج جست‌وجو</span></nav>
